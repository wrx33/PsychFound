...
from tinyzero.verl.single_controller.base.megatron.worker import MegatronWorker
from tinyzero.verl.workers.actor.megatron_actor import MegatronPPOActor
from tinyzero.verl.workers.critic.megatron_critic import MegatronPPOCritic
from tinyzero.verl.workers.sharding_manager import AllGatherPPModel
from tinyzero.verl.workers.reward_model.megatron.reward_model import MegatronRewardModel
...
from tinyzero.verl.utils.model import load_megatron_model_weights
from tinyzero.verl.utils.megatron_utils import init_model_parallel_config
from tinyzero.verl.utils.megatron_utils import offload_megatron_param_and_grad, load_megatron_param_and_grad
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    def _build_model_optimizer(self,
        ...
        from tinyzero.verl.utils.megatron.optimizer import get_megatron_optimizer
        from megatron.core.models.gpt.gpt_model import ModelType
        from tinyzero.verl.utils.model import print_model_size, update_model_config
        from tinyzero.verl.utils.megatron_utils import get_model, init_megatron_optim_config
        ...
        def megatron_actor_model_provider(pre_process, post_process):
            from tinyzero.verl.utils.model import get_parallel_model_from_config
    ...
    def _build_rollout(self):
        if self.config.rollout.name == 'vllm':
            ...
            from tinyzero.verl.workers.sharding_manager import MegatronVLLMShardingManager
            from tinyzero.verl.utils.model import normalize_pp_vpp_params
...
class CriticWorker(MegatronWorker):
    ...
    def _build_critic_model_optimizer(self,
        ...
        from tinyzero.verl.utils.model import print_model_size, update_model_config
        from tinyzero.verl.utils.megatron.optimizer import get_megatron_optimizer
        from tinyzero.verl.utils.megatron_utils import get_model, init_megatron_optim_config, init_model_parallel_config
        from transformers import AutoModelForCausalLM, AutoTokenizer, AutoConfig
...
class RewardModelWorker(MegatronWorker):
    ...
    def _build_rm_model(self, model_path, megatron_config: ModelParallelConfig, override_model_config):
        from megatron.core.models.gpt.gpt_model import ModelType
        from tinyzero.verl.utils.model import print_model_size, update_model_config
        from tinyzero.verl.utils.megatron_utils import get_model
        from transformers import AutoModelForCausalLM, AutoTokenizer, AutoConfig
