...
import torch
from tinyzero.verl.utils.reward_score import gsm8k, math, multiply, countdown, diagnosis, medication
from tinyzero.verl.trainer.ppo.ray_trainer import RayPPOTrainer
...
def _select_rm_score_fn(data_source):
    ...
    elif "diagnosis" in data_source:
        return diagnosis.compute_score
    elif 'medication' in data_source:
        return medication.compute_score
    else:
...
def main_task(config):
    ...
    if config.reward_model.enable:
        if config.reward_model.strategy == 'fsdp':
            ...
            from tinyzero.verl.workers.megatron_workers import RewardModelWorker
        else:
            raise NotImplementedError
