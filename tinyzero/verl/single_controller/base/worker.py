...
from tinyzero.verl.single_controller.base.decorator import register, Dispatch, Execute
    ...
    def _get_node_ip(self):
        ...
        def get_node_ip_by_sdk():
            if os.getenv("WG_BACKEND", None) == "ray":
                ...
                from tinyzero.verl.single_controller.torchrpc.k8s_client import get_ip_addr
                return get_ip_addr()
            return None
...
class Worker(WorkerHelper):
    ...
    def _configure_before_init(self, register_center_name: str, rank: int):
        ...
        if rank == 0:
            ...
            if os.getenv("WG_BACKEND", None) == "ray":
                from tinyzero.verl.single_controller.base.register_center.ray import create_worker_group_register_center
