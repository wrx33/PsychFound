...
from tinyzero.verl.protocol import DataProtoFuture
...
def _split_args_kwargs_data_proto(chunks, *args, **kwargs):
    from tinyzero.verl.protocol import DataProto, DataProtoFuture
    splitted_args = []
    for arg in args:
...
def dispatch_megatron_compute(worker_group, *args, **kwargs):
    ...
    """
    from tinyzero.verl.single_controller.base.megatron.worker_group import MegatronWorkerGroup
...
def dispatch_dp_compute(worker_group, *args, **kwargs):
    from tinyzero.verl.single_controller.base.worker_group import WorkerGroup
