...
def main():
    ...
    from tinyzero.verl.utils.torch_functional import pad_sequence_to_length
    ...
    from tinyzero.verl.workers.rollout.vllm_rollout.vllm_rollout import _pre_process_inputs
